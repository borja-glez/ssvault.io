  ...
  return (
    <div class="surface-card p-4 sm:p-5 md:p-7">
      ...
      <form class="grid gap-6" onSubmit={(e) => e.preventDefault()}>
        ...
        {/* Row C: Profile + Calibration + Version */}
        <div class="grid gap-5 grid-cols-[1fr_auto] sm:grid-cols-[1fr_1fr_auto]">
